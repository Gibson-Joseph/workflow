...
INSERT INTO "new_WorkflowExecution" ("completedAt", "createAt", "id", "startedAt", "status", "trigger", "workflowId") SELECT "completedAt", "createAt", "id", "startedAt", "status", "trigger", "workflowId" FROM "WorkflowExecution";
